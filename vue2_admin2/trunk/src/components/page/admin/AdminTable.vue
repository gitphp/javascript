    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="phone" label="电话" :formatter="formatter">
                </el-table-column>
                <el-table-column prop="status" label="状态" :formatter="formatter">
                </el-table-column>
                <el-table-column prop="atime" label="创建时间" :formatter="formatter">
                </el-table-column>
...
<script>
    export default {
        ...
        data() {
            return {
                url: 'http://192.168.31.201:6688/index.php?m=admin&c=index&a=index',
                tableData: [],
                cur_page: 1,
                multipleSelection: [],
                select_account: '',
